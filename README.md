...
This project focuses on analyzing 2024 flight data using Apache Hadoop, HDFS, MapReduce, and Apache Pig. The main goal is to process large-scale flight records and extract useful information about airline operations, delays, cancellations, diversions, and delay causes.
...
Analyzing this data manually is difficult when the dataset becomes large. Therefore, Hadoop-based distributed processing techniques are used to process the flight dataset efficiently.
...
The project helped demonstrate the practical use of distributed data storage and processing using Hadoop and Pig.